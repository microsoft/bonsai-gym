...
function computeMove(input: ObservableState): Action {
    if input.dap == 40 { return { anfer: 27 } }
    else if input.dap == 45 { return { anfer: 35 } }
    else if input.dap == 80 { return { anfer: 54 } }
    else { return { anfer: 0 }}
  }
